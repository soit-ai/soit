...
from app.modules.domains.identity.models import (
    User,
    Tenant,
    Workspace,
    TenantMembership,
...
from app.modules.domains.identity.repository import (
    UserRepository,
    TenantRepository,
    WorkspaceRepository,
...
from app.modules.domains.identity.schemas import (
    UserCreate,
    TenantCreate,
    WorkspaceCreate,
    MembershipCreate,
...
class IdentityService:
    ...
    def authenticate_user(
        ...
        memberships = self.membership_repo.get_by_user(user.id)
    ...
    def create_workspace(
        ...
        """
        workspace_repo = WorkspaceRepository(self.db, ctx)
        ...
        # Create owner membership
        membership_repo = WorkspaceMembershipRepository(self.db, ctx)
    ...
    def add_tenant_member(
        ...
        existing = self.membership_repo.get(tenant_id, membership_data.user_id)
        if existing:
    ...
    def add_workspace_member(
        ...
        tenant_membership = self.membership_repo.get(ctx.tenant_id, membership_data.user_id)
    ...
    def get_user_tenant_role(
        ...
        Returns:
            Role string or None if not a member.
        """
        membership = self.membership_repo.get(tenant_id, user_id)
        return membership.role if membership else None
