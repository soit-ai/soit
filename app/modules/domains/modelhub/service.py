...
from app.modules.domains.modelhub.models import Model
from app.modules.domains.modelhub.repository import ModelRepository
from app.modules.domains.modelhub.schemas import ModelCreate, ModelUpdate
...
class ModelHubService:
    ...
    def __init__(self, db: Session, ctx: RequestContext):
        ...
        self.db = db
        self.ctx = ctx
        self.model_repo = ModelRepository(db, ctx)
