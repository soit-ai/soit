...
from app.api.v1.thread.dependencies import get_thread_query_service, get_thread_runtime_service
from app.api.v1.thread.handlers import ThreadHandlers
...
from app.kernel.runtime.schemas import ThreadCreateRequest, ThreadDetailResponse, ThreadResponse, ThreadUpdateRequest
...
async def create_thread(
    ...
    runtime_service: RuntimeCoreService = Depends(get_thread_runtime_service),
    query_service: RuntimeQueryService = Depends(get_thread_query_service),
):
    """Create a runtime thread."""
...
async def list_threads(
    ...
    service: RuntimeQueryService = Depends(get_thread_query_service),
):
