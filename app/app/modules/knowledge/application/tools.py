...
Knowledge tool entrypoints backed by the knowledge runtime.
"""
...
async def knowledge_query(
    ...
    """Query knowledge for retrieval results (agent tool)."""
    ...
    try:
        ...
        response = await service.query(knowledge_id, query_request)
