"""dataset_ingest_worker

Run dataset ingestion tasks in the background for a specific tenant/workspace.

Usage:
    python scripts/dataset_ingest_worker.py --tenant-id t1 --workspace-id w1
    python scripts/dataset_ingest_worker.py --tenant-id t1 --workspace-id w1 --once
"""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run dataset ingestion worker.")
