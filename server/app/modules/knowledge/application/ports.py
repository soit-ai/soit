...
Protocols (ports) for the knowledge runtime application layer.
...
class DocumentRepositoryPort(Protocol):
    ...
    def list_by_knowledge(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_next_version(self, *args: Any, **kwargs: Any) -> Any: ...
    def count_by_knowledge(self, *args: Any, **kwargs: Any) -> Any: ...
