        ...
        "graph": {
            "nodes": [
                ...
                },
                {
                    ...
                    "type": "output",
                    "params": {
                        "ticket_id": "{{ steps.response.output.ticket_id }}",
                        "status": "{{ steps.response.output.status }}",
                        "response": "{{ steps.response.output.response }}",
                        "citations": "{{ steps.response.output.citations }}",
                    },
                },
            ],
            "edges": [
                ...
                {"id": "e_approval_ticket", "from": "approval", "to": "ticket_tool"},
                {"id": "e_ticket_response", "from": "ticket_tool", "to": "response"},
                {"id": "e_response_end", "from": "response", "to": "end"},
            ],
        },
    }
