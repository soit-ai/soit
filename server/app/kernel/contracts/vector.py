...
class VectorDocument:
    ...
    def from_dict(cls, data: dict[str, Any]) -> VectorDocument:
        ...
        return cls(
            ...
            text=data.get("text"),
            vector=list(vector) if isinstance(vector, list) else None,
...
class VectorQuery:
    ...
    def from_dict(cls, data: dict[str, Any]) -> VectorQuery:
        ...
        return cls(
            ...
            vector=list(data.get("vector") or []),
...
class VectorQueryMatch:
    ...
    def from_dict(cls, data: dict[str, Any]) -> VectorQueryMatch:
        ...
        return cls(
            document=VectorDocument.from_dict(document) if isinstance(document, dict) else document,
