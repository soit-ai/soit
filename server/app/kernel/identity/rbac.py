...
async def require_workflow_read(ctx: RequestContext, workflow_id: str, owner_id: str | None = None) -> None:
    """Require read permission on workflow (async)."""
    await require_resource_read_async(ctx, RESOURCE_WORKFLOW, workflow_id, owner_id)


async def require_workflow_write(ctx: RequestContext, workflow_id: str, owner_id: str | None = None) -> None:
    """Require write permission on workflow (async)."""
    await require_resource_write_async(ctx, RESOURCE_WORKFLOW, workflow_id, owner_id)


async def require_workflow_delete(ctx: RequestContext, workflow_id: str, owner_id: str | None = None) -> None:
...
async def require_knowledge_read(ctx: RequestContext, knowledge_id: str, owner_id: str | None = None) -> None:
    """Require read permission on knowledge (async)."""
    await require_resource_read_async(ctx, RESOURCE_KNOWLEDGE, knowledge_id, owner_id)


async def require_knowledge_write(ctx: RequestContext, knowledge_id: str, owner_id: str | None = None) -> None:
...
async def require_knowledge_delete(ctx: RequestContext, knowledge_id: str, owner_id: str | None = None) -> None:
