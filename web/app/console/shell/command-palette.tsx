...
const JUMP_TARGETS: { labelKey: TranslationKey; to: string }[] = [
  { labelKey: 'console.nav.overview', to: '/' },
  { labelKey: 'console.nav.chat', to: '/chat' },
  { labelKey: 'console.nav.agents', to: '/build/agents' },
  { labelKey: 'console.nav.workflows', to: '/build/workflows' },
  { labelKey: 'console.nav.knowledge', to: '/build/knowledge' },
  { labelKey: 'console.nav.plugins', to: '/build/plugins' },
  { labelKey: 'console.nav.models', to: '/build/models' },
  { labelKey: 'console.nav.tasks', to: '/execute/tasks' },
  { labelKey: 'console.nav.schedules', to: '/execute/schedules' },
