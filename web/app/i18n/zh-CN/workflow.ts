  ...
  detail: {
    ...
    build: {
      ...
      toast: {
        ...
        saved: '工作流保存成功',
        saveFailed: '保存工作流版本失败。',
        metadataSaveFailed: '工作流版本已保存，但更新工作流元数据失败。',
        preparingRun: '正在保存草稿并启动测试运行...',
        runFailed: '启动工作流测试运行失败。',
        exported: '工作流导出成功',
        imported: '工作流导入成功',
      },
      export: {
    ...
    setting: {
      ...
      execution: {
        title: '执行设置',
        description: '执行行为属于各个草稿版本。请前往构建器继续编辑草稿。',
        builderLink: '前往构建器配置执行设置',
      },
      access: {
        title: '访问控制',
        description: '配置工作流可见性',
        visibilityLabel: '可见性',
    ...
    callConfig: {
      playground: {
        title: 'Workflow 调试台',
        description: '通过受支持的 HTTP 和 SSE 端点向 {{name}} 发送真实请求。',
        endpoint: '端点',
        authHint: '浏览器会使用当前会话；外部调用方必须携带有效的 Bearer Token 和工作区请求头。',
        inputs: '输入 JSON',
        modes: {
          httpDescription: '执行 Workflow 并接收一次 JSON 响应。',
          sseDescription: '执行 Workflow，并实时查看服务端推送的每个事件。',
        },
        actions: {
          sendHttp: '发送 HTTP 请求',
          sending: '发送中...',
        ...
        errors: {
          ...
          objectRequired: '输入必须是 JSON 对象。',
          requestFailed: 'Workflow 请求失败。',
        },
        httpResult: 'HTTP 响应',
        sseEvents: 'SSE 事件',
        emptyEvents: '事件流运行后，事件会显示在这里。',
        curlSample: 'cURL 示例',
        toast: {
          copied: '已复制到剪贴板',
          copyFailed: '复制失败',
