const translation = {
  ...
  setAdminAccountDesc: '管理员拥有最高权限，可用于创建 Agent、管理 LLM 供应商等。',
  createAndSignIn: '创建账户',
  oneMoreStep: '还差一步',
  createSample: '基于这些信息，我们将为您创建一个示例 Agent',
  invitationCode: '邀请码',
  ...
  rightDesc: '简单构建可视化、可运营、可持续改进的 AI Agents',
  tos: '使用协议',
  pp: '隐私政策',
  tosDesc: '使用即代表您同意我们的',
  ...
  license: {
    tip: '启动 Soit 社区版之前, 请阅读 GitHub 上的',
    link: '开源协议',
  },
  join: '加入 ',
  joinTipStart: '邀请你加入 ',
  ...
  licenseExpiredTip: '您所在空间的 Soit Enterprise 许可证已过期，请联系管理员以继续使用 Soit。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接 Soit 许可证服务器，请联系管理员以继续使用 Soit。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '您所在空间的 Soit Enterprise 许可证尚未激活，请联系管理员以继续使用 Soit。',
}
