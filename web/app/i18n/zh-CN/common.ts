const translation = {
  ...
  model: {
    params: {
      ...
      response_formatTip: '指定模型生成的响应格式。选择“自动”则由模型自行决定格式。',
      response_formatPlaceholder: '选择响应格式',
      ...
      seed: '随机种子',
      seedTip: '设置随机种子可以保证相同输入产生相同的输出。不设置则每次生成的结果可能不同。',
      seedRandom: '随机',
    },
    tone: {
      Creative: '创意',
  ...
  account: {
    ...
    langGeniusAccount: 'Soit 账号',
    langGeniusAccountTip: '您的 Soit 账号和相关的用户数据。',
    editName: '编辑名字',
    showAppLength: '显示 {{length}} 项',
    delete: '删除账户',
  ...
  members: {
    ...
    owner: '所有者',
    admin: '管理员',
    adminTip: '能够构建 Agent 与 Workflow，并管理团队设置',
    normal: '成员',
    normalTip: '只能使用已发布资源，不能构建 Agent 或 Workflow',
    editor: '编辑',
    editorTip: '能够构建并编辑共享的 Agent 与 Workflow，不能管理团队设置',
    ...
    invitationSentTip: '邀请已发送，对方登录 Soit 后即可访问你的团队数据。',
    invitationLink: '邀请链接',
    ...
    deleteMember: '删除成员',
    you: '（你）',
    builderTip: '可以构建和编辑自己的 Agent 与 Workflow',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: '体验',
      exhausted: '超出限额',
      desc: '托管 OpenAI 由 Soit 提供的托管 OpenAI 服务，你可以使用 GPT-3.5 等模型，在体验额度消耗完毕前你需要设置其它模型供应商。',
      callTimes: '调用次数',
  ...
  about: {
    changeLog: '更新日志',
    updateNow: '现在更新',
    nowAvailable: 'Soit {{version}} 现已可用。',
    latestAvailable: 'Soit {{version}} 已是最新版本。',
  },
  appMenus: {
    overview: '监测',
    promptEng: '编排',
  ...
  knowledgeMenus: {
    ...
    hitTesting: '召回测试',
    settings: '设置',
    emptyTip: '此知识库尚未被任何资源引用。请参阅文档获取指导。',
    viewDoc: '查看文档',
    relatedApp: '个关联资源',
    noRelatedApp: '无关联资源',
  },
