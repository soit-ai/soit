const translation = {
  ...
  welcome: '👋 Welcome to Soit, please log in to continue.',
  email: 'Email address',
  ...
  setAdminAccountDesc: 'Maximum privileges for the admin account, including creating agents and managing LLM providers.',
  createAndSignIn: 'Create and sign in',
  oneMoreStep: 'One more step',
  createSample: 'Based on this information, we’ll create a sample agent for you',
  ...
  rightDesc: 'Effortlessly build visually compelling, operable, and improvable AI agents.',
  ...
  license: {
    tip: 'Before starting Soit Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Soit',
  invalid: 'The link has expired',
  explore: 'Explore Soit',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Soit and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Soit Enterprise license for your workspace has expired. Please contact your administrator to continue using Soit.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Soit license server. Please contact your administrator to continue using Soit.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Soit Enterprise license for your workspace is inactive. Please contact your administrator to continue using Soit.',
}
