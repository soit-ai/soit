const translation = {
  ...
  knowledgeUsedByApp: 'This knowledge base is referenced by active resources. They will lose access after deletion, and related prompt configurations and logs will be permanently deleted.',
  knowledgeDeleted: 'Knowledge deleted',
  knowledgeDeleteFailed: 'Failed to delete Knowledge',
  didYouKnow: 'Did you know?',
  intro1: 'The Knowledge can be integrated into agents and workflows ',
  intro2: 'as shared context',
  intro3: ',',
  intro4: 'or it ',
  intro5: 'can be managed',
  intro6: ' as a reusable knowledge resource',
  ...
  workspaceDashboard: {
    header: {
      ...
      description: 'Monitor knowledge freshness, index health, retrieval quality, and Agent reference risk.',
      create: 'Create Knowledge Base',
    },
    metrics: {
    ...
    toolbar: {
      searchPlaceholder: 'Search knowledge name or tags',
      filter: 'Filter',
      allTime: 'All time',
      refresh: 'Refresh',
    },
    alert: {
      ...
      description: 'Finance policy index failed, affecting retrieval chains for 3 Agents',
      action: 'View incident',
    },
    table: {
      empty: 'No matching knowledge base',
    },
    pagination: {
      totalSuffix: 'total',
      pageSizeSuffix: '/ page',
  ...
  detail: {
    sidebar: {
      nav: {
        ...
        usages: 'Usages',
        usagesDesc: 'Resources referencing this knowledge base',
        crawler: 'Crawler',
