const translation = {
  ...
  detail: {
    ...
    callConfig: {
      testAdapter: {
        ...
        placeholders: {
          inputs: 'Enter JSON inputs',
          options: 'Enter JSON options (optional)',
        },
        validation: {
          inputsRequired: 'Please enter inputs',
          inputsInvalid: 'Inputs must be valid JSON',
  ...
  adapterTest: {
    ...
    subtitle: 'Test different workflow invocation adapters',
    tabs: {
      http: 'HTTP API',
      function: 'Function call',
      mcp: 'MCP protocol',
    ...
    form: {
      ...
      workflowPlaceholder: 'Select a workflow to test',
      adapterLabel: 'Adapter type',
      inputsLabel: 'Inputs (JSON)',
      inputsRequired: 'Please enter inputs',
      inputsInvalid: 'Inputs must be valid JSON',
      inputsPlaceholder: 'Enter JSON inputs',
      optionsLabel: 'Options (JSON)',
      optionsInvalid: 'Options must be valid JSON',
      optionsPlaceholder: 'Enter JSON options (optional)',
      submit: 'Test {{adapter}} call',
    },
    loading: 'Calling workflow...',
