const translation = {
  ...
  model: {
    params: {
      ...
      response_formatTip: 'Specify the response format for the model response. Select "Auto" to let the model decide.',
      response_formatPlaceholder: 'Select response format',
      response_formatOptions: {
        auto: 'Auto',
        json_object: 'JSON object',
        text: 'Plain text',
      },
      seed: 'Seed',
      seedTip: 'Setting a seed ensures the same input produces the same output. Leave it empty for varied results.',
      seedRandom: 'Random',
    },
    tone: {
      Creative: 'Creative',
    ...
    option: {
      ...
      titleWithName: 'Model Parameters - {{name}}',
      srLabel: 'Model parameter settings',
    },
    selector: {
  ...
  account: {
    ...
    langGeniusAccount: 'Soit account',
    langGeniusAccountTip: 'Your Soit account and associated user data.',
    editName: 'Edit Name',
    showAppLength: 'Show {{length}} items',
  ...
  members: {
    ...
    owner: 'Owner',
    admin: 'Admin',
    adminTip: 'Can build agents and workflows, and manage team settings',
    normal: 'Normal',
    normalTip: 'Can use published resources, but can not build agents or workflows',
    builder: 'Builder',
    builderTip: 'Can build and edit owned agents and workflows',
    editor: 'Editor',
    editorTip: 'Can build and edit shared agents and workflows',
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Soit to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Soit allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'Soit {{version}} is now available.',
    latestAvailable: 'Soit {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
  ...
  knowledgeMenus: {
    ...
    settings: 'Settings',
    emptyTip: 'This knowledge base has not been linked to any resource yet. Please refer to the documentation for guidance.',
    viewDoc: 'View documentation',
    relatedApp: 'linked resources',
    noRelatedApp: 'No linked resources',
  },
  voiceInput: {
    speaking: 'Speak now...',
