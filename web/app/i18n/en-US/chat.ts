const chat = {
  ...
  thread: {
    ...
    approval: {
      ...
      description: 'The agent is paused. Review every pending action before continuing.',
      defaultMessage: 'This action requires your confirmation',
      approve: 'Approve',
      reject: 'Reject',
