  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "bg-elevated fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[var(--radius-xl)] border border-border/70 p-6 shadow-[0_24px_60px_rgba(2,6,23,0.24)] backdrop-blur-xl outline-none sm:max-w-xl",
