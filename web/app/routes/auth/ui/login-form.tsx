  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={cn('flex flex-col gap-6', className)} {...props}>
      <div className="space-y-2 text-center">
        <h2 className="text-2xl font-semibold tracking-tight text-slate-950 dark:text-white">Login to your account</h2>
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-2">
          <div className="flex items-center">
            ...
            <Link
              to="/forgot-password"
              className="ml-auto text-sm text-slate-500 underline-offset-4 hover:text-slate-950 hover:underline dark:text-slate-400 dark:hover:text-white"
            >
        ...
        <Button type="submit" className="h-11 w-full rounded-lg" disabled={loginMutation.isPending}>
