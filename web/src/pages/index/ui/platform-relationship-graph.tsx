...
function GraphNode({ node, onOpen }: { node: PositionedModule; onOpen: (href: string) => void }) {
  ...
  return (
    <button
      ...
      className={`group absolute w-[220px] -translate-x-1/2 -translate-y-1/2 rounded-[24px] border border-slate-200/70 bg-white/92 p-4 text-left transition-colors hover:border-slate-300 dark:border-slate-800 dark:bg-slate-950/86 bg-gradient-to-br ${node.tone}`}
...
export function PlatformRelationshipGraph({
  ...
  return (
    <>
      <div className="rounded-[24px] border border-slate-200/70 bg-slate-50/90 p-4 dark:border-slate-800 dark:bg-slate-900/60">
      ...
      <div className="hidden rounded-[28px] border border-slate-200/70 bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.12),transparent_26%),radial-gradient(circle_at_center,rgba(15,23,42,0.04),transparent_62%)] p-5 dark:border-slate-800 dark:bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.14),transparent_26%),radial-gradient(circle_at_center,rgba(15,23,42,0.22),transparent_62%)] lg:block">
        <div className="relative h-[560px] overflow-hidden rounded-[24px] border border-slate-200/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.72)_0%,rgba(248,250,252,0.82)_100%)] dark:border-slate-800 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.56)_0%,rgba(15,23,42,0.76)_100%)]">
