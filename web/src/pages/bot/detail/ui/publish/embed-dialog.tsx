...
import { Code, Copy, ExternalLink, Link, MessageCircle } from 'lucide-react'
...
export function EmbedDialog({ open, onOpenChange, embedType, onEmbedTypeChange }: EmbedDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl overflow-hidden">
        <DialogHeader>
          <DialogTitle>嵌入到网站中</DialogTitle>
          <DialogDescription>
            选择一种方式将聊天应用嵌入到你的网站中
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
          <div className="flex items-center justify-center space-x-8 mb-6">
            <div className="flex-1 max-w-[600px]">
              <RadioGroup value={embedType} onValueChange={onEmbedTypeChange} className="grid grid-cols-3 gap-4">
