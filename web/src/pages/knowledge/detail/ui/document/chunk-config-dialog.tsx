      ...
      <DialogContent>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="chunk_size" className="text-right">
              {t('knowledge.document.chunk.config.chunk_size')}
            </Label>
            <Input
              id="chunk_size"
              type="number"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="chunk_overlap" className="text-right">
              {t('knowledge.document.chunk.config.chunk_overlap')}
            </Label>
            <Input
              id="chunk_overlap"
              type="number"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="separator" className="text-right">
              {t('knowledge.document.chunk.config.separator')}
            </Label>
            <Input
              id="separator"
        ...
        <div className="flex justify-end gap-2">
          <Button variant="outline" onClick={() => onOpenChange(false)}>
            {t('knowledge.document.chunk.config.cancel')}
          </Button>
          <Button onClick={handleSave}>{t('knowledge.document.chunk.config.save')}</Button>
        </div>
      </DialogContent>
    </Dialog>
  )
