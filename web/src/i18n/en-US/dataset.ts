const translation = {
  ...
  detail: {
    sidebar: {
      nav: {
        ...
        applicationDesc: 'Apps using this dataset',
        crawler: 'Crawler',
      ...
      empty: 'No dataset selected',
      infoTitle: 'About',
      noDescription: 'No description',
      noTags: 'No tags',
      manageDocs: 'Manage Documents',
      toast: {
        fetchError: 'Failed to fetch dataset',
      },
    },
  },
  application: {
  ...
  crawler: {
    title: 'Crawler',
    description: 'Submit a webpage URL and ingest it as a dataset document.',
    actions: {
      ingest: 'Ingest URL',
      refresh: 'Refresh',
  ...
  setting: {
    ...
    basic: {
      ...
      description: 'Manage basic dataset information.',
      name: 'Name',
    ...
    danger: {
      title: 'Danger Zone',
      description: 'Deleting a dataset permanently removes its data.',
      deleting: 'Deleting...',
  ...
  query: {
    title: 'Query Test',
    description: 'Run a retrieval test on this dataset.',
  ...
  common: {
    id_missing: 'Dataset ID is missing',
    id_or_doc_id_missing: 'Dataset ID or Document ID is missing',
  },
}
