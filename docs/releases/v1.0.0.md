...
SOIT is released under the Apache License 2.0 with additional usage
conditions stated in the project README: operating SOIT as a hosted service
for multiple organizations requires a commercial license from SOIT LLC, and
the frontend LOGO and copyright notice may not be removed or modified.
